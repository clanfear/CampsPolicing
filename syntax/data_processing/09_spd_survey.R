...
spd_survey <- read_csv("./data/raw/customer_satisfaction_surveys/SPDCSWv1-45.csv", guess_max = 9012) %>%
  select(id = ID,
         beat = Beat,
         call_date = CallDate,
...
save(spd_survey, file = "./data/derived/disaggregated/spd_survey.RData")
