...
load("./data/derived/bg/tent_census_summer_2019_tract.RData")
load("./data/derived/bg/acs5_tract_2019.RData")
load("./data/derived/bg/spd_public_tract_month.RData")
load("./data/derived/bg/unauthorized_camping_complaints_monthly_tract.RData")
...
comp_prop_panel_bg_quarter <- comp_prop_panel_bg_month %>%
  group_by(blockgroup, quarter) %>%
...
save(comp_prop_panel_bg_quarter, file = "./data/derived/analysis/comp_prop_panel_bg_quarter.RData")
